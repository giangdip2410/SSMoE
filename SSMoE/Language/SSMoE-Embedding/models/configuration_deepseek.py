...
class DeepseekConfig(PretrainedConfig):
    ...
    Args:
        ...
        use_svd (`bool`, *optional*, defaults to `False`):
            Whether to use SVD Router.
        c (float, *optional*, defaults to 0.5)
            Combination ratio of SVD Router and SMoE Router
        k (float, *optional*, defaults to 50)
            Number of Candidate Eigenvectors that best fit with SMoE Router
    ...
    def __init__(
        ...
        attention_dropout=0.0, use_svd=True, c=0.5, k=50, 
        **kwargs,
    ):
